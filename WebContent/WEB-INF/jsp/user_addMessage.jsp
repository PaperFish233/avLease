...
<body>
<form action="${pageContext.request.contextPath}/addMessageUser" method="post" style="text-align: center">

<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>音像租赁系统——发布新留言</legend>
</fieldset>
...
<div class="layui-form-item"  style="margin-top:5%;">
    ...
    <div class="layui-form-item">
      ...
      <a class="layui-btn layui-btn-primary" href="${pageContext.request.contextPath}/allMessagesUser" >取消</a>
    </div>
