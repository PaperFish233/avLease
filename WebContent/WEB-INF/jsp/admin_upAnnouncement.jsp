...
<body>
<form action="${pageContext.request.contextPath}/upAnnouncementById" method="post" style="text-align: center">

<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>音像租赁系统——更新公告</legend>
</fieldset>
...
<div class="layui-form-item">
    ...
    <div class="layui-form-item">
          <div class="layui-inline">
    <label class="layui-form-label"  style="width: 120px; ">公告内容：</label>
    <div class="layui-input-inline">
    ...
    <div class="layui-form-item">
      ...
      <a class="layui-btn layui-btn-primary" href="${pageContext.request.contextPath}/allAnnouncements" >取消</a>
    </div>
